...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Make the query:
		$q = "INSERT INTO r4 (id_num, o_len, o_wid, o_lay, i_len, i_wid, i_lay, date) VALUES ('$id', '$ln', '$ow', '$ol', '$iln', '$iw', '$il', '$da')";		
		$r = @mysqli_query ($dbc, $q); // Run the query.
		if ($r) { // If it ran OK.
		
			// Print a message:
			echo '<h1>Thank you!</h1>
		<p>You have updated Rip Saw #4 records.</p><p><br /></p>';	
...
?>
<h1>Rip Cut Four</h1>
<form action="rip4.php" method="post">
